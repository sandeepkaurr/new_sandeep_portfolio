  ...
  const cards = [
    {
      ...
      description:
        "A dynamic and responsive restaurant website showcasing menu, online reservations, customer reviews, and contact information.",
    ...
    },
    {
      ...
      description:
        '"An AI-powered chess system that recognizes physical pieces and plays autonomously using computer vision and advanced game algorithms."',
    ...
    },
    {
      ...
      description:
        "an innovative twist on the classic snake game, allowing players to control the snake's movements through hand gestures, providing an engaging and interactive gaming experience.",
